...
function HeroStage({
  ...
  return (
    <div className={`hero-stage relative aspect-[3/4] w-full ${className}`}>
        ...
        <div ref={figureRef} className="hero-figure-parallax w-full h-full">
          <div className="hero-figure-in w-full h-full">
            <img
              ...
              loading="eager"
              fetchPriority="high"
              className="absolute bottom-[-2%] right-[-3%] h-[108%] md:h-[120%] lg:h-[128%] w-auto max-w-none object-contain object-bottom drop-shadow-[0_42px_64px_oklch(0.20_0.03_200/0.36)]"
            />
          </div>
        </div>
      </div>
